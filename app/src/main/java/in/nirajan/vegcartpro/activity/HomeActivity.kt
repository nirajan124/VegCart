...
import `in`.nirajan.vegcartpro.model.ItemModel
import `in`.nirajan.vegcartpro.adapter.HomeAdapter
import `in`.nirajan.vegcartpro.model.UserDetailModel
import `in`.nirajan.vegcartpro.utils.Constants.USER_DETAIL
import `in`.nirajan.vegcartpro.utils.SharedPreferenceUtils
import `in`.nirajan.vegcartpro.utils.Utility.getDeviceId
import `in`.nirajan.vegcartpro.utils.Utility.getDeviceManufacturer
import `in`.nirajan.vegcartpro.utils.Utility.getDeviceModel
import `in`.nirajan.vegcartpro.utils.Utility.getOsVersionName
import `in`.nirajan.vegcartpro.R
import `in`.nirajan.vegcartpro.utils.Constants.REQUEST_CODE_UPDATE
